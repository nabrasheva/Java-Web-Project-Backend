...
ALTER TABLE task
  ...
  ADD CONSTRAINT unique_task_version UNIQUE (id, version);

ALTER TABLE user
    ADD CONSTRAINT unique_user_version UNIQUE (id, version);

ALTER TABLE event
    ADD CONSTRAINT unique_event_version UNIQUE (id, version);

ALTER TABLE event_user
    ADD CONSTRAINT unique_event_user_version UNIQUE (id, version);
*/
-- ---
-- CREATE TABLE event_manager.events (
--    id  BIGSERIAL PRIMARY KEY,
