...
insert into event_manager.users (username, email, password, first_name, last_name, profile_picture_url, date_of_birth, address, created_date, last_modified_date) values ('Niya123', 'niya@test.com', '123', 'Niya', null, null, null, null, '2023-05-29 00:00:00.000000', '2023-05-29 00:00:00.000000');
insert into event_manager.users (username, email, password, first_name, last_name, profile_picture_url, date_of_birth, address, created_date, last_modified_date) values ('Georgi', 'georgi@test.com', '123', 'Georgi', 'Cekov', null, null, null, '2023-05-29 00:00:00.000000', '2023-05-29 00:00:00.000000');
insert into event_manager.users (username, email, password, first_name, last_name, profile_picture_url, date_of_birth, address, created_date, last_modified_date) values ('Tsvetina', 'tsvetina@test.com', '123', null, 'Rasheva', null, null, null, '2023-05-29 00:00:00.000000', '2023-05-29 00:00:00.000000');

insert into event_manager.tasks (name, description, due_date, status, creator_username, created_date, last_modified_date, event_id) values ('Order flowers', null, '2023-05-31', 'TO_DO', 'Niya123', '2023-05-29 00:00:00.000000', '2023-05-29 00:00:00.000000', 1);
insert into event_manager.tasks (name, description, due_date, status, creator_username, created_date, last_modified_date, event_id) values ('Invite guests', null, '2023-06-23', 'TO_DO', 'Niya123', '2023-05-29 00:00:00.000000', '2023-05-29 00:00:00.000000', 1);
insert into event_manager.tasks (name, description, due_date, status, creator_username, created_date, last_modified_date, event_id) values ('Order party cake', null, '2023-06-14', 'TO_DO', 'Georgi', '2023-05-29 00:00:00.000000', '2023-05-29 00:00:00.000000', 2);
insert into event_manager.tasks (name, description, due_date, status, creator_username, created_date, last_modified_date, event_id) values ('Buy dress', null, '2023-06-22', 'TO_DO', 'Tsvetina', '2023-05-29 00:00:00.000000', '2023-05-29 00:00:00.000000', 3);
